...
### An intelligent Smart-Scheduler that generates University timetable using `Genetic Algorithm`.

  A wrorking version of the prototype:- ['Smart Scheduler']
...
* `git clone https://github.com/Aatik-Mirajakar/Smart-Scheduler/`
* `cd M1`
* `python manage.py runserver`
* then go to port `http://127.0.0.1:8000/smart_scheduler/` to run the local server
